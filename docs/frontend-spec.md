...
| AI escalation brief | `digestText` rendered with whitespace-pre-wrap in a "Brief for CSCO" card, footer chip `Generated by openai/gpt-oss-120b (Groq cloud LLM)`. Keep attribution visible. |
